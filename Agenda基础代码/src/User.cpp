...
using namespace std;
  ...
  */
  User::User(const string &t_userName, const string &t_userPassword,
       const string &t_userEmail, const string &t_userPhone):m_name(t_userName),m_password(t_userPassword),m_email(t_userEmail),m_phone(t_userPhone){}
  ...
  */
  void User::setName(const string &t_name){m_name=t_name;}
  ...
  */
  void User::setPassword(const string &t_password){m_password=t_password;}
  ...
  */
  void User::setPhone(const string &t_phone){m_phone=t_phone;}
